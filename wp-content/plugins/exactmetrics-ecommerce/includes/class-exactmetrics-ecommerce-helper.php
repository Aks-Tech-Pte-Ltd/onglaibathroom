...
/**
 * Class ExactMetrics_eCommerce_Helper
 */
class ExactMetrics_eCommerce_Helper {
	...
	public static function woocommerce_test_mode( $order_id = 0 ) {
		...
		if ( apply_filters( 'exactmetrics_ecommerce_track_test_payments', false ) ) {
			return false;
		}
	...
	public static function round_price( $original_price ) {
		...
		return apply_filters( 'exactmetrics_ecommerce_price_rounding', $price, $original_price );
	}
	...
	/**
	 * Get ExactMetrics_EasyAffiliate class instance.
	 *
	 * @return object
	 * @since 8.0.2
	 */
	public static function easy_affiliate() {
		return new ExactMetrics_EasyAffiliate();
	}
