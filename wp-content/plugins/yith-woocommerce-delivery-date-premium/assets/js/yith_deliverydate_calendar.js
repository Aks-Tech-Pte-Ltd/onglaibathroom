...
var calendar = jQuery('#ywcdd_general_calendar'),
    ...
    getDate = function (element) {
        ...
        let date;
        try {
            date = jQuery.datepicker.parseDate(ywcdd_calendar_params.dateformat, element.value);
        } catch (error) {
    ...
    init_datepicker = function () {
        ...
        jQuery(document).find('.holiday_from').on('change', function () {
            var from_field = jQuery(this),
                parent = from_field.parent().parent().parent().parent(),
