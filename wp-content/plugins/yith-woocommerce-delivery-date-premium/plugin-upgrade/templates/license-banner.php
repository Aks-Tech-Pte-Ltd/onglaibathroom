	...
	<div class="<?php echo esc_attr( $classes ); ?>" data-slug="<?php echo esc_attr( $slug ); ?>" data-security="<?php echo esc_attr( wp_create_nonce( $slug ) ); ?>">
		...
		<div class="yith-plugin-upgrade-license-banner__content">
			<div class="yith-plugin-upgrade-license-banner__content__head">
				<span class="yith-plugin-upgrade-license-banner--hide-inline"><?php esc_html_e( 'Please, enter a license key to use', 'yith-plugin-upgrade-fw' ); ?></span>
				<span class="yith-plugin-upgrade-license-banner--hide-modal"><?php esc_html_e( 'Please, enter a license key to use this plugin.', 'yith-plugin-upgrade-fw' ); ?></span>
			</div>
			<div class="yith-plugin-upgrade-license-banner__content__plugin-name yith-plugin-upgrade-license-banner--hide-inline">
				<?php echo esc_html( $plugin_name ); ?>
			</div>
			<div class="yith-plugin-upgrade-license-banner__content__message">
				<?php echo wp_kses_post( __( '<mark>Remember:</mark> <strong>Plugins without a license can damage your shop</strong> and pose serious security risks, from installing backdoors to hijacking your shop for criminal purposes. Only with an active license for this plugin will you be able to keep your shop secure and get regular updates and support.', 'yith-plugin-upgrade-fw' ) ); ?>
			</div>
		</div>
