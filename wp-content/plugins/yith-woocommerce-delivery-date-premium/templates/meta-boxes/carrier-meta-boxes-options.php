<?php
/**
 * This file contain the calendar fields
 *
		...
		'carrier_settings' => array(
			...
			'fields' => array(
				'ywcdd_dayrange'         => array(
					...
					'desc'  => __( 'Set the number of days essential to your carrier to deliver the order (Set the value to 0 if the delivery occurs within the same day)', 'yith-woocommerce-delivery-date' ),
					'type'  => 'number-select',
					'std'   => array(
						array(
							'shipping_zone' => 'all',
