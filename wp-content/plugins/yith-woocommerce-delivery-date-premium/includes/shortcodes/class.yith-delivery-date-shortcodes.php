...
/**
 * The class that manage the plugin shortcode
 *
 * @package YITH WooCommerce Delivery Date\Classes\Shortcodes
 */
...
if ( ! class_exists( 'YITH_Delivery_Date_Shortcodes' ) ) {
	...
	class YITH_Delivery_Date_Shortcodes {
		...
		/**
		 * Show the delivery message with the shortcode
		 *
		...
		public static function print_dynamic_message_shortcode( $atts = array() ) {
			 ...
			 *
			 * This filter allow  to show the delivery info inside the product.
			 *
