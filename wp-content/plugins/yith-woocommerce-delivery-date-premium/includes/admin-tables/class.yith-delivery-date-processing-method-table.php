...
/**
 * Manage the Processing Method Post type table
 *
...
if ( ! class_exists( 'YITH_Processing_Method_Table' ) ) {
	/**
	 * Class YITH_Processing_Method_Table
	 */
	class YITH_Processing_Method_Table extends WP_List_Table {

		/**
		 * YITH_Processing_Method_Table constructor.
		 */
		...
		public function column_cb( $item ) {
			return sprintf(
				'<input type="checkbox" name="ywcdd_processing_method_ids[]" value="%s" />',
				$item
			);
		}
			...
			switch ( $column_name ) {
				...
				case 'post_title':
					...
					if ( $delete ) {
						...
						) . '" class="submitdelete">' . __( 'Delete permanently', 'yith-woocommerce-delivery-date' ) . '</a>';
					} else {
		...
		public function get_bulk_actions() {
			...
			if ( isset( $_REQUEST['ywcdd_processing_method_ids'] ) ) {  // phpcs:ignore WordPress.Security.NonceVerification.Recommended, WordPress.Security.ValidatedSanitizedInput.InputNotSanitized

				$rules = wp_unslash( $_REQUEST['ywcdd_processing_method_ids'] );  // phpcs:ignore WordPress.Security.NonceVerification.Recommended, WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
