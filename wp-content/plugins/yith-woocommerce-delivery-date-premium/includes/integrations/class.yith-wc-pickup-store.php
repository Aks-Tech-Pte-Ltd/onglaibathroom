...
/**
 * Manage class that add integration with Pickup store
 *
...
if ( ! class_exists( 'YITH_Delivery_Date_WC_Pickup_Store' ) ) {
	/**
	 * Class YITH_Delivery_Date_WC_Pickup_Store
	 */
	class YITH_Delivery_Date_WC_Pickup_Store {
		/**
		 * YITH_Delivery_Date_WC_Pickup_Store constructor.
		 */
		public function __construct() {

			add_filter( 'woocommerce_settings_api_form_fields_wc_pickup_store', array( $this, 'add_custom_fields' ), 5, 1 );
		...
		public function hide_duplicate_rows( $hide, $key, $shipping_id ) {
			...
			if ( 'wc_pickup_store' === $shipping_id ) {
				$hide = true;
			}
...
new YITH_Delivery_Date_WC_Pickup_Store();
