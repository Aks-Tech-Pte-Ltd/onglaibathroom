...
/**
 * Manage class that add integration with Table Rate
 *
...
if ( ! class_exists( 'YITH_Delivery_Date_WC_Table_Rate' ) ) {
	...
	class YITH_Delivery_Date_WC_Table_Rate {
		/**
		 * YITH_Delivery_Date_WC_Table_Rate constructor.
		 */
		...
		/**
		 * Add custom field in the shipping instance
		 *
		 * @author YITH <plugins@yithemes.com>
		 * @since 1.0.0
		 */
		public function set_shipping_option() {
			add_filter( 'woocommerce_shipping_instance_form_fields_betrs_shipping', array( $this, 'add_custom_fields' ), 100, 1 );
		}
