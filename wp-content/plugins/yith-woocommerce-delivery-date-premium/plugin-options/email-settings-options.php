<?php
/**
 * Plugin options : Email options file
 *
...
$desc         = sprintf(
	'%s<ul><li>%s</li><li>%s</li><li>%s</li><li>%s</li><li>%s</li><li>%s</li><li>%s</li><li>%s</li></ul>',
...
/**
 * APPLY_FILTERS: yith_delivery_date_mail_settings
 *
 * Change the email settings.
 *
 * @param array $email_options the options.
 *
 * @return string
 */
