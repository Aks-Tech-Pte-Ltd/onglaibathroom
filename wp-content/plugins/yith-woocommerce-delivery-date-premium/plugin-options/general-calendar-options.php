<?php
/**
 * Plugin options : Calendar options file
 *
...
$holiday_title     = sprintf(
	'<p>%s</p><p class="info-box"><strong>%s</strong> %s</p>',
...
$calendar_settings = array(
	'general-calendar' => array(
		...
		'calendar_color_shipp'                 => array(
			...
			'default'   => '#ff643e',
			'desc'      => __( 'Set a background color for your ship to carrier events', 'yith-woocommerce-delivery-date' ),
		),
