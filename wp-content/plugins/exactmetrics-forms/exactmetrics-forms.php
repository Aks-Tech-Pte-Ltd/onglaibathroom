...
class ExactMetrics_Forms
{
	...
	private function check_compatibility()
	{
		...
		$compatibility = ExactMetrics_Forms_Compatibility_Check::get_instance();
	...
	public function init()
	{
		...
		if (version_compare(EXACTMETRICS_VERSION, '7.3.1', '<')) {
...
?>
	...
	?>
		<div class="error">
			<p><?php esc_html_e('Please install or update ExactMetrics Pro with version 7.3.1 or newer to use the ExactMetrics Forms addon', 'exactmetrics-forms'); ?></p>
		</div>
<?php
	}
