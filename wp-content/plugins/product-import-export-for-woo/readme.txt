...
Easily import/export WooCommerce products (simple, grouped, external/affiliate) via CSV. The plugin now auto-generates product descriptions with ChatGPT API integration.
...
= 2.3.2 2023-07-13 =
* [Fix] - 'null' value exported to the stock column if manage stock is disabled
* [Fix] - Variable products are converted as simple products when updating
* [Update] - Tested OK with WooCommerce 7.8.2
= 2.3.1 2023-06-12 =
