 ...
 */
class ExactMetrics_Onboarding_Wizard_Pro {
	...
	public function __construct() {
		...
		add_action( 'exactmetrics_after_ajax_activate_addon', array( $this, 'disable_optin_monster_onboarding_wizard' ) );
	...
	public function onboarding_wizard_header() {
		...
		<head>
			...
			<title><?php esc_html_e( 'ExactMetrics &rsaquo; Onboarding Wizard', 'exactmetrics-premium' ); ?></title>
...
new ExactMetrics_Onboarding_Wizard_Pro();
