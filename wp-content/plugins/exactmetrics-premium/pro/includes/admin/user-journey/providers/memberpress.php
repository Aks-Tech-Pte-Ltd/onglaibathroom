 ...
 * @since 8.7.0
 */
class ExactMetrics_Pro_User_Journey_MemberPress_Metabox extends ExactMetrics_User_Journey_Pro_Metabox {
...
if ( defined( 'MEPR_VERSION' ) ) {
	new ExactMetrics_Pro_User_Journey_MemberPress_Metabox();
}
