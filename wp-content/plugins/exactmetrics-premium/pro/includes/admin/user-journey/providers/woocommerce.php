 ...
 * @since 8.5.0
 */
class ExactMetrics_Pro_User_Journey_WooCommerce_Metabox extends ExactMetrics_User_Journey_Pro_Metabox {
	...
	public function add_user_journey_metabox() {
		add_meta_box(
			'woocommerce-exactmetrics-pro-user-journey-metabox',
...
if ( class_exists( 'WooCommerce' ) ) {
	new ExactMetrics_Pro_User_Journey_WooCommerce_Metabox();
}
