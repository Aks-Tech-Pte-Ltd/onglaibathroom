 ...
 * @since 8.7.0
 */
class ExactMetrics_Pro_User_Journey_Restrict_Content_Pro_Metabox extends ExactMetrics_User_Journey_Pro_Metabox {
	...
	public function metabox_title() {
		?>
		<div class="exactmetrics-metabox-title">
...
if ( class_exists( 'Restrict_Content_Pro' ) ) {
	new ExactMetrics_Pro_User_Journey_Restrict_Content_Pro_Metabox();
}
