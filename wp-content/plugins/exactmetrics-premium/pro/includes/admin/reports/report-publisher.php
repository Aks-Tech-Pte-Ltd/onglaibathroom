...
final class ExactMetrics_Report_Publisher extends ExactMetrics_Report {

	public $title;
	public $class = 'ExactMetrics_Report_Publisher';
	...
	public function __construct() {
		$this->title = __( 'Publishers', 'exactmetrics-premium' );
		parent::__construct();
	}
