...
final class ExactMetrics_Report_YearInReview extends ExactMetrics_Report {

	public $title;
	public $class = 'ExactMetrics_Report_YearInReview';
	...
	public function __construct() {
		$this->title = __( 'Year in Review', 'exactmetrics-premium' );
		parent::__construct();
	}
