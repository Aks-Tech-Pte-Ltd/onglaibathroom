...
final class ExactMetrics_Notification_To_Enable_Ecommerce_Tracking extends ExactMetrics_Notification_Event {
	...
	public function prepare_notification_data( $notification ) {
		...
		if ( !class_exists('ExactMetrics_eCommerce') && (
			...
			$notification['title'] = __( 'Enable our eCommerce addon to instantly track sales and revenue in Google Analytics', 'exactmetrics-premium' );
			...
			$notification['btns']    = array(
				"activate_addon" => array(
					'url'  => $this->get_view_url( 'exactmetrics-addon-ecommerce', 'exactmetrics_settings', 'addons' ),
